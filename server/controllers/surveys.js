...
//Display the initial page for creating a survey
    ...
    schema.Results.find({
        ...
        if (err) {
            ...
            for (let count = 0; count < answers.length; count++) {
                ...
                dataset.push({
                        topic_name: answers[count].questionTopic,
                        first_ans: answers[count].ans["a1"],
                        first_ans_res: answers[count].ans["a1result"],

                        second_ans: answers[count].ans["a2"],
                        second_ans_res: answers[count].ans["a2result"],

                        third_ans: answers[count].ans["a3"],
                        third_ans_res: answers[count].ans["a3result"],
                        total: answers[count].ans["total"]
                    }
